...
- Разработка и доработка страниц корпоративного сайта на WordPress, JavaScript, HTML,
CSS/SCSS.
- Разработка сложных UI-компонентов: таблицы, фильтры, формы, модальные окна и
диагностические инструменты.
- Интеграция frontend с REST API, обработка состояний загрузки, ошибок и данных от backend.
- Улучшение SEO и обеспечение кроссбраузерной совместимости
- Работа с GitLab, submodules, Dockerfile и feature-документирование.
- Улучшение взаимодействия с backend-сервисом, путем использования React Query.
...
**ООО «Стартех База»** — Frontend-разработчик (Декабрь 2022 - Ноябрь 2025) 
- Перевод сборки проекта с Webpack на Vite, ускорение сборки и повышение стабильности.
- Обновление библиотек и замена устаревших решений на современные и
оптимизированные аналоги.
- Улучшение SEO и обеспечение кроссбраузерной совместимости.
- Оптимизация и обновление процессов CI/CD в GitHub Actions.
- Подготовка и выравнивание графических материалов в Photoshop.
- Реализация новых страниц по макетам из Figma.
- Улучшение взаимодействия с backend-сервисом, путем использования React Query.
- Внедрение анимаций на сайт с помощью Framer Motion.
- Настройка линтинга (ESLint) и форматирования кода (Prettier).
- Внедрение системы тестирования: E2E (Cypress) и UI (Storybook + Chromatic).
- Документация проекта и кода (README.md)
- Дальнейшая поддержка и развитие проекта: добавление новых функций, оптимизация производительности, обновление библиотек на новые версии и улучшение UX новыми решениями и подходами.

**ООО «СКРАПЕР»** — Frontend-разработчик (Апрель 2024 — Октябрь 2024)
- Полная настройка инфраструктуры проекта: Next.js конфигурация c Typescript, стилизация (TailwindCSS), архитектура приложения, линтер (ESLint + Prettier), GitHub Actions.
- Реализация клиентсткой части по макету Figma используя Next.js и современные React-библиотеки. Добавление анимаций с помощью "Framer Motion".
- Добавление интернационализации с помощью библиотеки "i18next".
- Настройка взаимодействие с backend-сервисом (SWR + Axios), включая работу с WebSockets, а также с сервисом платежей (Тинькофф/Stripe).
- Подготовка и выравнивание графических материалов в Photoshop.
- Дальнейшая поддержка и развитие проекта: добавление новых функций, оптимизация производительности, обновление библиотек на новые версии и улучшение UX новыми решениями и подходами.
...
информационной безопасности, автоматизации бизнес-процессов и импортозамещения.)

• https://base.startech.vc/
(Коммерческое крупное SPA-приложение предоставляющее крупную базу стартапов, услуги продвижения, а также сервис поиска и размещения технологических решений.)

• https://scraper-ai.ru/
(Коммерческое веб-приложение для парсинга сайтов с отображением результатов в реальном времени.)

• https://restaurant-sedlo.vercel.app/
(Одностраничный сайт, демонстрирующий дизайн ресторанного заведения с акцентом на UX и анимации.)

• https://kuroko-web-inky.vercel.app/
